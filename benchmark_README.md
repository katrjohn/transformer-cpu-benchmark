...
> TinyGreekNewsBERT achieves **~20× fewer FLOPs** and **~10× lower CPU latency** than XLM-RoBERTa, while remaining within 5 F1 points on NER. See the [full paper](https://doi.org/10.1109/ACCESS.2025.XXXXXXX) for the complete model comparison.
